...
**Jekyll** で静的サイト生成 → **Netlify** でホスティング → **Decap CMS**（旧Netlify CMS）でブログ編集 → **GitHub OAuth**（Netlify Functions による自前認証プロキシ）
...
| サービス | 用途 | アカウント |
|---------|------|----------|
| GitHub | ソース管理・OAuth | `kmukawa0126` |
| Netlify | ホスティング・Functions・ビルド | 旧URL: `frolicking-bublanina-a90bb7.netlify.app` |
